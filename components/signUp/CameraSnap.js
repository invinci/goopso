...
const flashAutoImage = require('image!flashAuto');
const flashOnImage = require('image!flashOn');
const flashOffImage = require('image!flashOff');
const flashArray = [
  {
  ...
  renderSwitchCameraButton() {
    return (
      <TouchableOpacity style={{paddingHorizontal: 15}} onPress={this.onSwitchCameraPressed}>
        <Image
          style={{flex: 1, justifyContent: 'center'}}
          source={require('image!cameraFlipIcon')}
          resizeMode={Image.resizeMode.contain}
        />
      </TouchableOpacity>
    );
      ...
      <View style={styles.captureButtonContainer}>
        ...
        >
          <Image
            ...
            source={require('image!cameraButton')}
            resizeMode={'contain'}
          />
        </TouchableOpacity>
      </View>
