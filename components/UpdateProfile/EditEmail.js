...
class EditEmail extends Component {
  ...
  render() {
    ...
    return (
      <View style={{flex:1}}>
        <NavigationBar
             title={<Text style={{fontWeight:'700',fontFamily:'din round pro',fontSize:16}}>EMAIL</Text>}
            leftButton= {
        ...
        <ScrollView style={{flex: 1,backgroundColor: '#dbd9d9'}}>
          <View style={{flex: 1, flexDirection:'row', marginTop: 20, backgroundColor:'white',height: 60, padding: 20}}>
            <View style={{flex: 0.3}}>
              <Text style={{color:'#b7b7b7',fontSize:16,fontWeight:'600',fontFamily:'din round pro',color:'black'}}>Email</Text>
            </View>
            <View style={{flex: 0.7}}>
              <TextInput
                autoCorrect={false}
          ...
          <View style={{alignItems:'center',marginVertical:10, paddingLeft: 6}}>
            <Text style={{color:'#b7b7b7',fontSize:14,fontFamily:'din round pro'}}>
              You can update your email here on <Text style={{fontWeight: 'bold'}}>Goopso</Text>. If you do, other people will be able to find you by this username and contact you without knowing your phone number. </Text>
