...
class EditEmail extends Component {
  ...
  render() {
    ...
    return (
      <View style={{flex:1}}>
        <NavigationBar
             title={<Text style={{fontWeight:'700',fontFamily:'din round pro',fontSize:16}}>PASSWORD</Text>}
            leftButton= {
        ...
        <ScrollView style={{flex: 1,backgroundColor: '#dbd9d9'}}>
          <View style={{flex: 1, flexDirection:'row', marginTop: 20, backgroundColor:'white',height: 60, padding: 20}}>
            <View style={{flex: 0.3}}>
              <Text style={{color:'#b7b7b7',fontSize:16,fontWeight:'600',fontFamily:'din round pro',color:'black'}}>Old Password</Text>
            </View>
            <View style={{flex: 0.7}}>
              <TextInput
                autoCorrect={false}
          ...
          <Text style={{color:'#b7b7b7',fontSize:14,fontFamily:'din round pro'}}>
               Please enter your current password to confirm  </Text>
          </View>
        </ScrollView>
